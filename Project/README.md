...
UI Framework:
Jetpack Compose: (เห็นจาก dependencies) ใช้สำหรับหน้าจอ UI ยุคใหม่
XML / View System: (เห็นจาก CardView, TextView, LinearLayout) ใช้จัดการ Layout หลักใน RoguelikeMainActivity
